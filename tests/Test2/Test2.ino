...
class prfServoImplMockUnit16 : public prfServo2ImplBase<uint16_t, double>
{
public:
...
class prfServoImplMockInt32 : public prfServo2ImplBase<int32_t>
{
public:

  void(*getStub)(float** params, float** params2);
  void get(float** params, float** params2) const override {
    getStub(params, params2);
  }
...
test(test_16_Servos_same_polynomial_forwards) {
  ...
  prfServo2<uint32_t, uint8_t, uint16_t, double> sixteenServos(&impl, 0x55555555, 0x00000000);
...
test(test_4_Servos_polynomials_of_different_order_backwards_forwards) {
  ...
  prfServoImplMockUnit16 impl;
  // Servo 0: order 1 + order 0, (100 + 10*x), backwards + 40
  // Servo 1: order 2 + order 0, (100 + 10*x + 5*x*x), backwards + 30
  // Servo 2: order 3 + order 0, (100 + 10*x + 5*x*x + 2*x*x*x), backwards + 20 
  // Servo 3: order 0 + order 0, 80, backwards + 10
  impl.getStub = &getResults4Servo;
